...
export default function Page() {
	return <Post header={header} comments={[
		...
		<p>I've notably worked on <Link href={"https://zenoh.io"}>Zenoh</Link> and <Link href={"https://ditto.live/"}>Ditto</Link>, and am the author of <Stabby />. I've given a few talks which I'll summarize in future posts, published a few papers... The usual nerd stuff</p>
