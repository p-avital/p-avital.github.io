...
export default function Page() {
	return <Post header={header}>
		...
		<p>I've notably worked on <Link href={"https://zenoh.io"}>Zenoh</Link> and <Link href={"https://ditto.live/"}>Ditto</Link>, and am the author of <Link href={"https://crates.io/crates/stabby"}><code>stabby</code></Link>. I've given a few talks which I'll summarise in future posts, published a few papers... The usual nerd stuff</p>
